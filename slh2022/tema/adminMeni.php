...
<!--  meni -->
      ...
      <nav class="navbar navbar-expand fixed-top"  style="background-color: #e5e5e5;" > 
			...
			<?php 
	  		...
	  		*/
	  			 	...
	  			 	<div class="btn-group">	
    			    	<form class="form-control-file" action="../upravljanje/routes.php" method="post" >	
	      				...
	      				<form class="form-control-file" action="../upravljanje/routes.php" method="post" >
	    					...
	    					<button type="submit" class="btn btn-outline-primary" style="background-color:#FFAF33;" name="page" value="SvaJedinjenja">Jedinjenja</button>		    	
	      				</form>
	      				
    	      			<form class="form-control-file" action="../upravljanje/routes.php" method="post" >
	    					<button class="btn btn-outline-primary"  type="submit" name="page" value="statistika" >Pregled</button>
            	      	</form>
			  ...
			  <?php 	}?>
  			  ...
  			  <ul class="navbar-nav "> 
    	    	<li class="nav-item">
      		   		 <a class="nav-link" href="../login/index.php" >KRAJ</a>
	    	    </li>
	       </ul>	 
 </nav>
